This "Visual Studio Solution" folder contains four "Project"s for experimenting on Lock-free (Non-blocking) queues (data structure). Lock-free data structures are data structures that are not implemented using thread locks (e.g., mutex).
